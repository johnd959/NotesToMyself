        ...
        <div className="flex flex-col justify-center gap-2 bg-black p-12 rounded-xl">
          ...
          <div className="flex flex-col gap-2">
            <input
              type="email"
              placeholder="Email"
              className="input input-sm min-w-full text-base"
              value={email}
            ...
            ></input>
            <div className={"label " + `${errM == "" ? "hidden" : ""}`}>
              {errM !== "" ? (
                <span className="text-error label-text">{errM}</span>
              ) : (
                <p></p>
              )}
            </div>
            ...
            <div className="label">
              <a
                className="label-text text-info cursor-pointer"
                onClick={() => setMenu(3)}
              >
                Forgot Password?
              </a>
    ...
    return (
      <main className="flex flex-col justify-center items-center min-h-screen">
        <div className="flex flex-col justify-center gap-2 bg-black p-12 rounded-xl">
          ...
          <div className="flex flex-col gap-2">
            <div
              className="tooltip tooltip-top md:tooltip-right tooltip-primary text-left"
              data-tip="Emails are used for password resets"
            >
              <input
                type="email"
                placeholder="Email"
            ...
            <div
              className="tooltip tooltip-top md:tooltip-right tooltip-primary text-left"
              data-tip="No preceding or trailing spaces"
            >
              <input
                type="password"
                placeholder="Password"
            ...
            <div className="label">
              {errM !== "" ? (
                <span className="label-text text-error">{errM}</span>
              ) : (
                <p></p>
              )}
            </div>
            <div className="flex flex-row gap-2 items-center justify-center">
              <Button
                title="Back"
                className="btn-primary rounded-r-none w-6/12"
                func={() => handleGoBack()}
              ></Button>
              <Button
                className="btn btn-primary px-6 rounded-l-none w-6/12"
                title="Next"
      ...
      <main className="flex flex-col justify-center items-center min-h-screen">
        <dialog id="reset_modal" className="modal">
          <div className="modal-box">
            ...
            <p className="py-4">
              If the email is valid, a link to reset your password has been sent
        ...
        <div className="flex flex-col justify-center gap-2 bg-black p-12 rounded-xl">
          ...
          <div className="flex flex-col gap-2">
            <div
              className="tooltip tooltip-top md:tooltip-right tooltip-primary text-left"
              data-tip="A password reset email will be sent to this address"
            >
              <input
                type="email"
                placeholder="Email"
